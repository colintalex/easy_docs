...
Role.create(tier: :public_user, display_name: 'public_user')
Role.create(tier: :tier1, display_name: 'tier1')
Role.create(tier: :tier2, display_name: 'tier2')
admin = Role.create(tier: :admin, display_name: 'admin')
...
doc = Document.create(title:'Test Document', note: 'This is for development.', access_level: :tier1)
...
doc2 = Document.create(title:'Squirrels', note: 'This is for development.', access_level: :public_user)
